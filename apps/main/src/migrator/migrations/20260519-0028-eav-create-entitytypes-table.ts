...
export async function up(sequelize: Sequelize): Promise<void> {
  ...
  await createTable(
    ...
    [
      ...
      'entityModelId INT NOT NULL ' + ref('EAVEntityModels', 'id', 'EAVEntityTypes', 'entityModelId'),
      'parentEntityTypeId INT NULL ' + ref('EAVEntityTypes', 'id', 'EAVEntityTypes', 'parentEntityTypeId'),
      'isDeleted ' + bit() + ' NULL',
      '"createdAt" ' + dt(),
      '"updatedAt" ' + dt(),
    ].join(',\n'),
