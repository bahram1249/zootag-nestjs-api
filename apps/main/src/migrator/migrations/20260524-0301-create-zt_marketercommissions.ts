...
export async function up(sequelize: Sequelize): Promise<void> {
  ...
  await createTable(
    'ZT_MarketerCommissions',
    [
      'id BIGINT ' + idCol + ' ' + pk,
      'marketerId BIGINT NOT NULL' +
        ' ' +
        ref('ZT_Marketers', 'id', 'ZT_MarketerCommissions', 'marketerId'),
      ...
      'createdUserId BIGINT NOT NULL' +
        ' ' +
        ref('Users', 'id', 'ZT_MarketerCommissions', 'createdUserId'),
      'updatedUserId BIGINT NOT NULL' +
        ' ' +
        ref('Users', 'id', 'ZT_MarketerCommissions', 'updatedUserId'),
