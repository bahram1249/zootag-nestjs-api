  ...
  await createTable(
    ...
    [
      ...
      'activityTypeId INT NOT NULL ' +
        ref('BPMNActivityTypes', 'id', 'BPMNActivities', 'activityTypeId'),
      'processId INT NOT NULL ' +
        ref('BPMNProcess', 'id', 'BPMNActivities', 'processId'),
      'haveMultipleItems ' + bit() + ' NOT NULL',
      'insideProcessRunnerId INT NULL ' +
        ref('BPMNProcess', 'id', 'BPMNActivities', 'insideProcessRunnerId'),
      'isDeleted ' + bit() + ' NULL',
      '"createdAt" ' + dt(),
      '"updatedAt" ' + dt(),
    ].join(',\n'),
