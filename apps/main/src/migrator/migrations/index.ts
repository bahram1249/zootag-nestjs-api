...
const m = (s: any): MigrationDefinition => ({ name: s.name, up: s.up, down: s.down });
const cond = (s: any, key: string, ...values: string[]): MigrationDefinition => ({
  name: s.name, up: s.up, down: s.down,
  condition: { key, values },
});

export const migrations: MigrationDefinition[] = [
  m(m0001), m(m0002), m(m0003), m(m0004), m(m0005),
  m(m0006), m(m0007), m(m0008), m(m0009), m(m0010),
  m(m0011), m(m0012), m(m0013), m(m0014), m(m0015),
  m(m0016), m(m0017), m(m0018), m(m0019), m(m0020),
  m(m0021), m(m0022), m(m0023), m(m0024), m(m0025),
  m(m0026),
  cond(m0027, 'SITE_NAME', 'ecommerce'), cond(m0028, 'SITE_NAME', 'ecommerce'),
  cond(m0029, 'SITE_NAME', 'ecommerce'), cond(m0030, 'SITE_NAME', 'ecommerce'),
  cond(m0031, 'SITE_NAME', 'ecommerce'), cond(m0032, 'SITE_NAME', 'ecommerce'),
  cond(m0033, 'SITE_NAME', 'ecommerce'), cond(m0034, 'SITE_NAME', 'ecommerce'),
  cond(m0035, 'SITE_NAME', 'ecommerce'), cond(m0036, 'SITE_NAME', 'ecommerce'),
  cond(m0037, 'SITE_NAME', 'ecommerce'), cond(m0038, 'SITE_NAME', 'ecommerce'),
  cond(m0039, 'SITE_NAME', 'ecommerce'), cond(m0040, 'SITE_NAME', 'ecommerce'),
  cond(m0041, 'SITE_NAME', 'ecommerce'), cond(m0042, 'SITE_NAME', 'ecommerce'),
  cond(m0043, 'SITE_NAME', 'ecommerce'), cond(m0044, 'SITE_NAME', 'ecommerce'),
  cond(m0045, 'SITE_NAME', 'ecommerce'), cond(m0046, 'SITE_NAME', 'ecommerce'),
  cond(m0047, 'SITE_NAME', 'bpmn'), cond(m0048, 'SITE_NAME', 'bpmn'),
  cond(m0049, 'SITE_NAME', 'bpmn'), cond(m0050, 'SITE_NAME', 'bpmn'),
  cond(m0051, 'SITE_NAME', 'bpmn'), cond(m0052, 'SITE_NAME', 'bpmn'),
  cond(m0053, 'SITE_NAME', 'bpmn'), cond(m0054, 'SITE_NAME', 'bpmn'),
  cond(m0055, 'SITE_NAME', 'bpmn'), cond(m0056, 'SITE_NAME', 'bpmn'),
  cond(m0057, 'SITE_NAME', 'bpmn'), cond(m0058, 'SITE_NAME', 'bpmn'),
  cond(m0059, 'SITE_NAME', 'bpmn'), cond(m0060, 'SITE_NAME', 'bpmn'),
  cond(m0061, 'SITE_NAME', 'bpmn'), cond(m0062, 'SITE_NAME', 'bpmn'),
  cond(m0063, 'SITE_NAME', 'bpmn'), cond(m0064, 'SITE_NAME', 'bpmn'),
  cond(m0065, 'SITE_NAME', 'bpmn'), cond(m0066, 'SITE_NAME', 'bpmn'),
  cond(m0067, 'SITE_NAME', 'bpmn'), cond(m0068, 'SITE_NAME', 'bpmn'),
  cond(m0069, 'SITE_NAME', 'bpmn'), cond(m0070, 'SITE_NAME', 'bpmn'),
