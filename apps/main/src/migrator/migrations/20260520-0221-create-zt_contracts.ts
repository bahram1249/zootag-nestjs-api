...
export async function up(sequelize: Sequelize): Promise<void> {
  const { createTable, idCol, pk, ref, nv, text, bit } =
  ...
  await createTable(
    ...
    [
      ...
      'companyId BIGINT NOT NULL' +
        ' ' +
        ref('ZT_Companies', 'id', 'ZT_Contracts', 'companyId'),
      ...
      'currencyId BIGINT NOT NULL' +
        ' ' +
        ref('ZT_Currencies', 'id', 'ZT_Contracts', 'currencyId'),
      'contractStatusId BIGINT NOT NULL' +
        ' ' +
        ref('ZT_ContractStatuses', 'id', 'ZT_Contracts', 'contractStatusId'),
      'notes ' + text() + ' NULL',
