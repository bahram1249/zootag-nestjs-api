...
export class CompanyResponseDto {
  ...
  @ApiProperty({ example: '123456789', description: 'Tax number', required: false })
  taxNumber?: string;

  @ApiProperty({ example: 'info@pettrack.com', description: 'Email', required: false })
  email?: string;

  @ApiProperty({ example: '+98-21-12345678', description: 'Phone', required: false })
  phone?: string;
